...
from app.models.ingestion.LectureDetailsBySubCategory import LectureDetailsBySubCategoryRequest, LectureDetailsBySubCategoryResponse
...
@router.get("/lecture-details", response_model=LectureDetailsBySubCategoryResponse)
async def fetch_lecture_details(request: LectureDetailsBySubCategoryRequest = Depends()):
    try:
